...
badd +7 typo_html.py
badd +0 typographify.txt
badd +4 as2cs.py
badd +19 as\as.def
badd +229 \archive\antlr\as3\AS3.g
badd +0 as\example\Empty.as
badd +0 cs.py
badd +0 design.txt
args As3ToCSharp.py
edit cs.py
...
exe 'vert 4resize ' . ((&columns * 65 + 67) / 134)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 242 - ((12 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
242
