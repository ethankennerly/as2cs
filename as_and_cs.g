...
function_declaration := function_modified / constructor_modified / function_default / constructor_default
constructor_default := ts, function_signature
constructor_modified := ts, namespace_modifiers, ts, function_signature
